...
#ifdef _SC_CODE_
extern int do_upgrade (cmd_tbl_t * cmdtp, int flag, int argc, char *argv[]);
U_BOOT_CMD(
	upgrade,	CFG_MAXARGS,	1,	do_upgrade,
 	"upgrade    - do upgrade...\n",
 	"upgrade\n" 	
);
extern int do_button(cmd_tbl_t * cmdtp, int flag, int argc, char *argv[]);
U_BOOT_CMD(
	do_button,	CFG_MAXARGS,	1,	do_button,
 	"test button    - do test button...\n",
 	"test button \n" 	
);
extern int do_assign(cmd_tbl_t * cmdtp, int flag, int argc, char *argv[]);
U_BOOT_CMD(
	assign,	CFG_MAXARGS,	1,	do_assign,
 	"assign    - do assign job...\n",
 	"assign \n" 	
);
extern int do_leds(cmd_tbl_t * cmdtp, int flag, int argc, char *argv[]);
U_BOOT_CMD(
	leds,	CFG_MAXARGS,	1,	do_leds,
 	"leds  - test leds...\n",
 	"leds \n" 	
);
#ifdef _LOOP_BACK_
extern int do_loopback(cmd_tbl_t * cmdtp, int flag, int argc, char *argv[]);
U_BOOT_CMD(
	loopback,	CFG_MAXARGS,	1,	do_loopback,
 	"loopback  - test loopback...\n",
 	"loopback \n" 	
);
#endif
extern int do_gpio_oe( cmd_tbl_t *cmdtp, int flag, int argc, char *argv[]);
U_BOOT_CMD(
	gpio_oe_set,	CFG_MAXARGS,	1,	do_gpio_oe,
 	"gpio_oe_set  - GPIO output enable set...\n",
 	"gpio_oe_set \n" 	
);
extern int do_gpio_set( cmd_tbl_t *cmdtp, int flag, int argc, char *argv[]);
U_BOOT_CMD(
	gpio_set_value,	CFG_MAXARGS,	1,	do_gpio_set,
 	"gpio_set_value  - GPIO value set...\n",
 	"gpio_set_value \n" 	
);
extern int do_gpio_get( cmd_tbl_t *cmdtp, int flag, int argc, char *argv[]);
U_BOOT_CMD(
	gpio_get_value,	CFG_MAXARGS,	1,	do_gpio_get,
 	"gpio_get_value  -GPIO value get...\n",
 	"gpio_get_value \n" 	
);
#endif
