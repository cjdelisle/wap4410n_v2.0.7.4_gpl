...
struct mtd_partition pesudo_partions[] =
{
	{
		name:           "RedBoot",
		size:           0x20000,
...
#define NB	(sizeof(pesudo_partions)/sizeof(struct mtd_partition))
...
*/
        ...
        {
            printk("Add static partition for flash bank %d\n", i);
	        add_mtd_partitions(mtd, pesudo_partions, NB);
        }
#endif
/*
 * End of Change
