...
/*
* For Native VLAN supoort
* By BZ@SC_CPUAP, At 2007-7-12
* Start of Change
*/
int (*check_native_vlan_p) (struct sk_buff *skb, struct net_device *dev) = NULL;  
/*
 * End of Change
 */
...
* Start of Change
*/
    if (check_native_vlan_p==NULL? 1 : !(*check_native_vlan_p)(skb, dev))
/*
 * End of Change
 */
...
* Start of Change
*/
EXPORT_SYMBOL (check_native_vlan_p);
/*
 * End of Change
 */
