...
#define SYS_CONTACT     "www.sercomm.com"

/* system location */
#define SYS_LOC     "sercomm"
...
#define VERS_DESC   "AP52nA Wireless AP"             /* overridden at run time */
#define SYS_NAME    "AP52nA"             /* overridden at run time */
...
#ifdef WAP4410N
#define SYSTEM_MIB		1,3,6,1,4,1,9,6,1,32,4410,1
#define SYSTEM_DOT_MIB		1.3.6.1.4.1.9.6.1.32.4410.1
#else
