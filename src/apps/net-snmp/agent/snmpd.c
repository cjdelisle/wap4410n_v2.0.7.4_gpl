...
extern char remoteManager[17];
/* <== Add End */ 
/* MD@CPU_AP add for linksy at 20080115 */
extern char remoteManager_end[17];
/* add end */ 
/*******************************************************************-o-******
 * main - Non Windows
...
#endif
{
    char            options[128] = "aAc:CdD::fhHI:l:LP:qrsS:UvV-:R:E:";
    int             arg, i, ret;
    int             dont_fork = 0;
    int             dont_zero_log = 0;
...
#endif
/* Add/Change By Terry Yang  Begin ==> */
    strcpy(remoteManager,"255.255.255.255");
/* <== Add End */ 
/* MD@CPU_AP add for linksy at 20080115 */
    strcpy(remoteManager_end,"0.0.0.0");
/* add end */ 
#ifdef LOGFILE
    ...
    while ((arg = getopt(argc, argv, options)) != EOF) {
        ...
        /* Add/Change By Terry Yang  Begin ==> */
        case 'R':
            strcpy(remoteManager, optarg);
            break;
        /* <== Add End */  
        /* MD@CPU_AP add for linksy at 20080115 */
        case 'E':
            strcpy(remoteManager_end, optarg);
            break;
        /* add end */    
        case '-':
