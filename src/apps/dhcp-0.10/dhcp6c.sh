...
#              Protocol for IPv6.
# processname: dhcp6c
# config: /tmp/dhcp6c.conf
# config: /tmp/sysconfig/dhcp6c

# Source function library.
. /tmp/rc.d/init.d/functions

# Source networking configuration.
. /tmp/sysconfig/network
. /tmp/sysconfig/dhcp6c
...
start() {
	...
	daemon /usr/local/sbin/dhcp6c -c /tmp/dhcp6c.conf ${DHCP6CARGS} ${DHCP6CIF}
	RETVAL=$?
	echo
