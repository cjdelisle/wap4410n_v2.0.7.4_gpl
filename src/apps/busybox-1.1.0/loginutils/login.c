...
/* mike add for telnet log msg     at 20071127 */
		syslog(LOG_NOTICE,"[SC][UnAuthLogin]Unauthorized Login Attempt on telnet ");
/* add end */
...
/* mike add for telnet log msg     at 20071127 */
    syslog(LOG_NOTICE,"[SC][AuthLogin]Authorized Login on telnet ");
/* add end */
	alarm ( 0 );
